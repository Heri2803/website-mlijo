...
<div class="card shadow bg-white">
    <div class="card-body row">
        ...
        <div class="col-md-4">
            <img src="/../../asset/img/<?php echo $pecah['Bukti_pembayaran'] ?>" width="250"
...
if (isset($_POST['proses'])) {
    ...
    $stmt = $koneksi->prepare("UPDATE pembelian SET status=$status WHERE id_pembelian=$id_pembelian");
    $stmt->bind_param("si", $status, $id_pembelian);
    $stmt->execute();
